<div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                        <?=form_open_multipart("user/profil/send_profil")?>
                            <?=$this->session->flashdata('pesan')?>
                            <div class="form-group">
                                <label>Nama </label>
                                <input type="text" name="nama" placeholder="Masukkan Nama Lengkap" value="<?=$user['nama']?>" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Tanggal Lahir</label>
                                <input type="date" name="ttl"  class="form-control" value="<?=$user['ttl']?>">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
