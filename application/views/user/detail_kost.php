                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="<?=base_url().'user/favorit/tambah_favorit'?>" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary mt-3 btn-sm">+ Tambahkan ke Favorit</button>
                            </form>
                            <?php }else{?>
                                <form action="<?=base_url().'user/favorit/hapus_favorit'?>" method="POST">
                                <input type="hidden" name="id_user" value="<?=$user['id']?>">
                                <input type="hidden" name="id_kost" value="<?=$kost['id']?>">
                                <button type="submit" class="btn btn-danger mt-3 btn-sm">Hapus dari Favorit</button>
                            </form>
                            <?php }?>
                        </td>
                    </tr>
