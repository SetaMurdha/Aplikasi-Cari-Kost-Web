...
REPLACE INTO `data_kost` (`id`, `nmkost`, `pemilik`, `id_kota_kab`, `alamat`, `telepon`, `harga`, `jenis`, `pembayaran`, `longitude`, `latitude`, `foto`) VALUES
	...
	(23, 'D\'Fortune Boarding House', 'Ibu Cindy', 1, 'Jl. Simpang S. Kalijaga V No.8, Dinoyo, Kec. Lowokwaru, Kota Malang, Jawa Timur 65149', '628118282190', 475000, 'Putri', 'Bulanan', 112.6023178, -7.9517288, NULL),
